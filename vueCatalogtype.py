...
class vueCatalogtype(QWidget):
    ...
    def init_ui(self):
        ...
        self.groupbox_profile_catalog_checkbox = QCheckBox("Profile Catalog")
        self.groupbox_sample_catalog_checkbox = QCheckBox("Sample Catalog")
        
        self.groupbox_trajectory_catalog_checkbox.setEnabled(True)
        self.groupbox_time_series_catalog_checkbox.setEnabled(True)
        self.groupbox_profile_catalog_checkbox.setEnabled(True)
        self.groupbox_sample_catalog_checkbox.setEnabled(True)
        ...
        self.groupbox_checkbox_layout.addWidget(self.groupbox_profile_catalog_checkbox)
        self.groupbox_checkbox_layout.addWidget(self.groupbox_sample_catalog_checkbox)
    ...
    def connect_signals(self):
        ...
        self.groupbox_profile_catalog_checkbox.toggled.connect(self.controleurcatalogtype.profile_catalog)
        self.groupbox_sample_catalog_checkbox.toggled.connect(self.controleurcatalogtype.sample_catalog)
